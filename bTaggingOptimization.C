...
void bTaggingOptimization_2Tag(const string& fDijetMassBin, const string& fBinLabel)
{
  ...
  TFile *file1 = new TFile("CRAB_Jobs_bTaggingEfficiency_Optimization_bPartonMatching/Final__histograms.root");
  TFile *file2 = new TFile("CRAB_Jobs_bTaggingEfficiency_Optimization_bPartonMatching/Final__histograms.root");
  TFile *file3 = new TFile("CRAB_Jobs_bTaggingEfficiency_Optimization_RSG_bPartonMatching/Final__histograms.root");
...
void bTaggingOptimization_2Tag_QCDInclusive(const string& fDijetMassBin, const string& fBinLabel)
{
  gROOT->SetBatch(kTRUE);
  gStyle->SetOptStat(kFALSE);
  gStyle->SetLabelSize(0.035, "XYZ");
  ...
  TFile *file1 = new TFile("CRAB_Jobs_bTaggingEfficiency_Optimization_QCD_InclusiveTagging_bPartonMatching/Final__histograms.root");
  TFile *file2 = new TFile("CRAB_Jobs_bTaggingEfficiency_Optimization_bPartonMatching/Final__histograms.root");
  TFile *file3 = new TFile("CRAB_Jobs_bTaggingEfficiency_Optimization_RSG_bPartonMatching/Final__histograms.root");
...
void makePlots()
{
  bTaggingOptimization_2Tag("DijetMass500to1000GeV", "0.5<M_{jj}<1 TeV");
  bTaggingOptimization_2Tag("DijetMass1000to1500GeV", "1<M_{jj}<1.5 TeV");
  bTaggingOptimization_2Tag("DijetMass1500to2000GeV", "1.5<M_{jj}<2 TeV");
  bTaggingOptimization_2Tag("DijetMass2000to2500GeV", "2<M_{jj}<2.5 TeV");
  bTaggingOptimization_2Tag("DijetMass2500to3000GeV", "2.5<M_{jj}<3 TeV");
  bTaggingOptimization_2Tag("DijetMass3000to3500GeV", "3<M_{jj}<3.5 TeV");
  bTaggingOptimization_2Tag("DijetMass3500to4000GeV", "3.5<M_{jj}<4 TeV");

  bTaggingOptimization_2Tag_QCDInclusive("DijetMass500to1000GeV", "0.5<M_{jj}<1 TeV");
  bTaggingOptimization_2Tag_QCDInclusive("DijetMass1000to1500GeV", "1<M_{jj}<1.5 TeV");
  bTaggingOptimization_2Tag_QCDInclusive("DijetMass1500to2000GeV", "1.5<M_{jj}<2 TeV");
  bTaggingOptimization_2Tag_QCDInclusive("DijetMass2000to2500GeV", "2<M_{jj}<2.5 TeV");
  bTaggingOptimization_2Tag_QCDInclusive("DijetMass2500to3000GeV", "2.5<M_{jj}<3 TeV");
  bTaggingOptimization_2Tag_QCDInclusive("DijetMass3000to3500GeV", "3<M_{jj}<3.5 TeV");
  bTaggingOptimization_2Tag_QCDInclusive("DijetMass3500to4000GeV", "3.5<M_{jj}<4 TeV");
}
