...
void bTaggingEfficiencyVsPt(const string& fInputFile1, const string& fInputFile2, const string& fPlot1, const string& fPlot2, const string& fAlgo,
                                   const string& fTitle, const string& fLabel, const string& fLegend1, const string& fLegend2, const string& fOutputFile,
                                   const Int_t nbins, const Double_t *xbins, const string& fXAxisTitle, const string& fYAxisTitle)
{
  gROOT->SetBatch(kTRUE);
  ...
  TH2D *h2_denom_Sample1 = (TH2D*)file1->Get((fPlot1 + "_HF").c_str());
  TH2D *h2_num_Sample1 = (TH2D*)file1->Get((fPlot1 + "_" + fAlgo).c_str());
  ...
  TH2D *h2_denom_Sample2 = (TH2D*)file2->Get((fPlot2 + "_HF").c_str());
  TH2D *h2_num_Sample2 = (TH2D*)file2->Get((fPlot2 + "_" + fAlgo).c_str());
...
//                                "b-tag_eff_PtJ2_etalt0p2_QCD_GSP_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,2} [GeV]", "b-tag efficiency");
  ...
  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-170to300_TuneZ2_7TeV_pythia6__ferencek-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04_skim-v2__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt170to300",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt170to300_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");

  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-300to470_TuneZ2_7TeV_pythia6__ferencek-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04_skim-v2__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt300to470",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt300to470_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");

  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-470to600_TuneZ2_7TeV_pythia6__elhughes-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt470to600",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt470to600_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");
  
  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-600to800_TuneZ2_7TeV_pythia6__elhughes-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt600to800",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt600to800_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");
  
  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-800to1000_TuneZ2_7TeV_pythia6__elhughes-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt800to1000",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt800to1000_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");

  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-1000to1400_TuneZ2_7TeV_pythia6__elhughes-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt1000to1400",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt1000to1400_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");
  
  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-1400to1800_TuneZ2_7TeV_pythia6__elhughes-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt1400to1800",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt1400to1800_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");

  bTaggingEfficiencyVsPt("CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/Final__histograms.root",
                         "CRAB_Jobs_bTaggingEfficiency_QCD_GSP_bPartonMatching/QCD_Pt-1800_TuneZ2_7TeV_pythia6__elhughes-Summer11-PU_S4_START42_V11-v1_EDMTuple_V00-00-04__histograms.root",
                         "QCD_Pythia6__h2_EtaJ1_vs_PtJ1",
                         "myAnalyzer/h2_EtaJ1_vs_PtJ1" ,
                         "TCHEM", "TCHEM, b parton matching", "|#eta|<0.2",
                         "QCD GSP", "QCD GSP Pt1800",
                         "b-tag_eff_PtJ1_etalt0p2_QCD_GSP_Incl_Pt1800_Pythia6_bPartonMatching.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");
