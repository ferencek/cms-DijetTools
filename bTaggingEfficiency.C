...
void makePlots()
{
  ...
  bTaggingEfficiencyVsPtJ1("CRAB_Jobs_bTaggingEfficiency_bcHadron/Final__histograms.root",
                           "QCD_Pythia6", "ZprimeBBbar" , "TCHEM",
                           "TCHEM, b or c hadron matching", "|#eta|<0.2",
                           "b-tag_eff_PtJ1_etalt0p2_QCD_Pythia6_ZprimeBBbar_bcHadron.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");

  bTaggingEfficiencyVsPtJ1("CRAB_Jobs_bTaggingEfficiency_bParton/Final__histograms.root",
                           "QCD_Pythia6", "ZprimeBBbar" , "TCHEM",
                           "TCHEM, b parton matching", "|#eta|<0.2",
                           "b-tag_eff_PtJ1_etalt0p2_QCD_Pythia6_ZprimeBBbar_bParton.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");
  
  bTaggingEfficiencyVsPtJ1("CRAB_Jobs_bTaggingEfficiency_bcHadron/Final__histograms.root",
                           "QCD_Pythia6", "QCD_MadGraph" , "TCHEM",
                           "TCHEM, b or c hadron matching", "|#eta|<0.2",
                           "b-tag_eff_PtJ1_etalt0p2_QCD_Pythia6_MadGraph_bcHadron.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");

  bTaggingEfficiencyVsPtJ1("CRAB_Jobs_bTaggingEfficiency_bParton/Final__histograms.root",
                           "QCD_Pythia6", "QCD_MadGraph" , "TCHEM",
                           "TCHEM, b parton matching", "|#eta|<0.2",
                           "b-tag_eff_PtJ1_etalt0p2_QCD_Pythia6_MadGraph_bParton.png", 15, PtBins, "p_{T,1} [GeV]", "b-tag efficiency");
